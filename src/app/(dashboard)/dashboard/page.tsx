  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-5 mb-6 sm:mb-10">
        <div className="bg-surface border border-border rounded-2xl p-4 sm:p-5 hover:shadow-sm transition-shadow">
          <div className="flex items-center gap-3 mb-2 sm:mb-3">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-primary/10 flex items-center justify-center">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#d45d3a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-text">{stats.menusCreated}</p>
        ...
        <div className="bg-surface border border-border rounded-2xl p-4 sm:p-5 hover:shadow-sm transition-shadow">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-text">{stats.liveMenus}</p>
        ...
        <div className="bg-surface border border-border rounded-2xl p-4 sm:p-5 hover:shadow-sm transition-shadow">
          <div className="flex items-center gap-3 mb-2 sm:mb-3">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gold/10 flex items-center justify-center">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c4943c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-text">{stats.totalItems}</p>
      ...
      {!hasMenus ? (
        <div className="bg-surface border border-border rounded-2xl p-6 sm:p-10 text-center">
          ...
          <h3
            className="text-lg sm:text-xl font-semibold text-text mb-2"
            style={{ fontFamily: 'var(--font-heading), serif' }}
          >
            No menus yet
          </h3>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 sm:px-6 py-3 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary-hover transition-colors shadow-sm hover:shadow-md"
          >
        ...
        <div className="bg-surface border border-border rounded-2xl p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              href="/dashboard/menus/new"
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary-hover transition-colors shadow-sm"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <line x1="12" y1="5" x2="12" y2="19" />
                <line x1="5" y1="12" x2="19" y2="12" />
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-border text-text text-sm font-medium hover:bg-cream transition-colors"
            >
              View All Menus
            </Link>
          </div>
